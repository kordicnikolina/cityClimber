          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Svi itemi</h3>
                <div class="card-tools">
                  
                  <a href="item-form" class="btn btn-success">
                  ...
                  <c:forEach var="item" items="${itemList}">
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          <a href="item-form-update?id=${item.id}" class="btn btn-info">
                            <i class="fas fa-edit"></i>
                          </a>
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#delete-modal-${item.id}">
                     ...
                     <div class="modal-body">
                        ...
                        <div class="modal-footer justify-content-between">
                          <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                           <a href="item-delete?id=${item.id}" class="btn btn-danger" >Delete</a>
