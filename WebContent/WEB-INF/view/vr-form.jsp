  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Visinski radovi Form</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#"> Visinski radovi</a></li>
          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                ...
                <h3 class="card-title"> Vr Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form:form role="form" modelAttribute= "vr" action="vr-save">
              <form:hidden path="id"/>
                <div class="card-body">
                  <div class="form-group">
                    <label>Slika</label>
                    <form:input path="slika" type="text" class="form-control" placeholder="url slike"/>
                  </div>
                  <div class="form-group">
                    <label>Text1</label>
                    <form:textarea path="text1" type="text" class="form-control" placeholder="Dodaj tekst"/>
                  </div>
                   <div class="form-group">
                    <label>Text2</label>
                    <form:textarea path="text2" type="text" class="form-control" placeholder="Dodaj tekst"/>
                  </div>
                   <div class="form-group">
                    <label>Text3</label>
                    <form:textarea path="text3" type="text" class="form-control" placeholder="Dodaj tekst"/>
                  </div>
                </div>
                <!-- /.card-body -->
