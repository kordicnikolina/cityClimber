          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Svi kontakti</h3>
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody id="sort-list">
                  <c:forEach var="kontakt" items="${kontaktList}">
                   <tr>
                      <td>
                      ...
                      <td>
                      <c:if test="${!kontakt.isSeen}">
                        <a href="kontakt-seen?id=${kontakt.id}" class="btn btn-block btn-danger btn-sm">Mark as seen</a>
                        </c:if>
                      </td>
