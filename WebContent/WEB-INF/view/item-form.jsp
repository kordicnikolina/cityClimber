          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                ...
                <h3 class="card-title"> ItemForm</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form:form role="form" modelAttribute= "item" action="item-save">
              <form:hidden path="id"/>
                <div class="card-body">
                  <div class="form-group">
                    <label>Slika</label>
                    <form:input path="slika" type="text" class="form-control" placeholder="Upisi url slike"/>
                  </div>
                  <div class="form-group">
                    <label>Naslov</label>
                    <form:input path="naslov" type="text" class="form-control" placeholder="Upisi naslov"/>
                  </div>
                  <div class="form-group">
                    <label>Link</label>
                    <form:input path="link" class="form-control" placeholder="Upisi link"/>
                  </div>
                  <div class="form-group">
                    <label>Linkurl</label>
                    <form:input path="linkurl" class="form-control" placeholder="Upisi url linka"/>
                  </div>
                  <div class="form-group">
                    <label>Tekst</label>
                    <form:textarea path="text" class="form-control" placeholder="Upisi tekst"/>
                  </div>
                <div class="custom-control custom-checkbox">
                 <form:checkbox class="custom-control-input"  id="customCheckbox1" path="isOnSlidebar"/>
                 <label for="customCheckbox1" class="custom-control-label">Show on slidebar</label>
               </div>
                </div>
                <!-- /.card-body -->
