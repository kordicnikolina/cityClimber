...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link" href="contact-list" aria-expanded="true">
        ...
        <li class="nav-item dropdown">
        <a class="nav-link" href="comment-list">
          <i class="far fa-bell"></i>
          <span class="badge badge-warning navbar-badge">${commentCount}</span>
        </a>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="#"> Usluge</a></li>
              <li class="breadcrumb-item active">Usluge Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                ...
                <h3 class="card-title"> Usluge Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form:form role="form" modelAttribute= "usluge" action="usluge-save">
              <form:hidden path="id"/>
                <div class="card-body">
                  <div class="form-group">
                    <label>Naziv</label>
                    <form:input path="naziv" type="text" class="form-control" placeholder="Upisi naziv"/>
                  </div>
                  <div class="form-group">
                    <label>Opis</label>
                    <form:textarea path="opis" type="text" class="form-control" placeholder="Dodaj opis usluge"/>
                  </div>
                  <div class="form-group">
                    <label>Slika</label>
                    <form:input path="slika" class="form-control" placeholder="Upisi slika url"/>
                  </div>
                </div>
                <!-- /.card-body -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019 <a href="">City Climber</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
