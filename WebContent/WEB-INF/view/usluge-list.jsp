        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Usluge</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Sve usluge</h3>
                <div class="card-tools">
                  
                  <a href="usluge-form" class="btn btn-success">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody id="sort-list">
                  <c:forEach var="usluge" items="${uslugeList}">
                    <tr>
                      <td>
                      ...
                      <td>
                        <strong>${usluge.naziv}</strong>
                      </td>
                      <td>
                        <strong>${usluge.opis}</strong>
                      </td>
                      <td>
                        <strong>${usluge.slika}</strong>
                      </td>
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          <a href="usluge-update-form?id=${usluge.id}" class="btn btn-info">
                            <i class="fas fa-edit"></i>
                          </a>
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#delete-modal-${usluge.id}">
                            <i class="fas fa-trash"></i>
                          </button>
                        </div>
                      </td>
                    </tr>
                   <div class="modal fade" id="delete-modal-${usluge.id}">
                    <div class="modal-dialog">
                     <div class="modal-content">
                       <div class="modal-header">
                       <h4 class="modal-title">Obrisi uslugu</h4>
                         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                         <span aria-hidden="true">&times;</span>
                        </button>
                       </div>
                     <div class="modal-body">
                         <p>Da li ste sigurni da zelite da obrisete ovu uslugu?</p>
                         <strong></strong>
                        </div>
                        <div class="modal-footer justify-content-between">
                          <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                           <a href="usluge-delete?id=${usluge.id}" class="btn btn-danger" >Delete</a>
